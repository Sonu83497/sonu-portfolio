                  ...
                  const content = (
                    <>
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-sm text-mist-200">{detail.value}</p>
                      </div>
                    </>
                  );
                  return (
                    <li key={detail.label}>
                      {detail.href ? (
                        <a href={detail.href} className="flex items-start gap-3">
                          {content}
                        </a>
                      ) : (
          ...
          >
            <GlassCard className="h-full">
              <form onSubmit={handleSubmit} className="grid gap-4">
                ...
                {status === "sent" && (
                  <p role="status" className="text-center text-xs text-sprout-400">
